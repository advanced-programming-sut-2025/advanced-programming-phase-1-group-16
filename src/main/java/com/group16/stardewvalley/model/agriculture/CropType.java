...
public enum CropType {
    ...
    COFFEE_BEAN("Coffee Bean", SeedType.COFFEE_BEANS_SUMMER, new int[]{1, 2, 2, 3, 2}, 10, false, 2, 15, false, -1, -1, List.of(Season.Spring, Season.Summer), false),
    ...
    UNMILLED_RICE("Unmilled Rice", SeedType.RICE_SHOOT, new int[]{1, 2, 2, 3}, 8, true, -1, 30, true, 3, 1, List.of(Season.Spring), false),
    ...
    SUNFLOWER("Sunflower", SeedType.SUNFLOWER_SEEDS_FALL, new int[]{1, 2, 3, 2}, 8, true, -1, 80, true, 45, 20, List.of(Season.Summer, Season.Fall), false),
